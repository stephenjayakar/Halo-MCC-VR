...
// Use the same exact target transforms as collision. Native object velocities
// can include a pending solver response that the visible object has not yet
// taken, which makes short render extrapolation overshoot a rotating prop.
